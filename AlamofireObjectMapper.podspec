Pod::Spec.new do |s|
  ...
  s.homepage = "https://github.com/TN-INCORPORATION/mymo-AlamofireObjectMapper"
  s.author = { "Tristan Himmelman" => "tristanhimmelman@gmail.com" }
  s.source = { :git => 'https://github.com/TN-INCORPORATION/mymo-AlamofireObjectMapper.git', :tag => s.version.to_s }
